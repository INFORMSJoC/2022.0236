...
from freeze_model import Actor, Critic
import torch
...
class Agent():
    ...
    def __init__(self, state_size, action_size, initialize, noise, lr, units, layer, site):
        ...
        self.actor_local = Actor(state_size, action_size, initialize, self.units, self.layer, self.site).to(device)
        self.actor_target = Actor(state_size, action_size, initialize, self.units, self.layer, self.site).to(device)
