...
def offline_test(n_site, budget, resource):
    ...
    path = 'result/transferRL_' + str(round(n_site)) + resource
    ...
    result_state.to_csv(r'RL_high_state_16.csv')
    result_new = pd.DataFrame(new_buffer)
    result_new.to_csv(r'RL_high_new_16.csv')